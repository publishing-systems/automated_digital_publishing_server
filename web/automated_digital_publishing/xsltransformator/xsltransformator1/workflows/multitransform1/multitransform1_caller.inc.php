 ...
 */
/**
 * @file $/web/automated_digital_publishing/xsltransformator/xsltransformator1/workflows/multitransform1/multitransform1_caller.inc.php
...
function multitransform1_caller($inputListFile, $stylesheetFile, $logDirectory)
{
    if (file_exists($inputListFile) !== true)
    {
        return -1;
    }

    if (file_exists($stylesheetFile) !== true)
    {
        return -2;
    }
    ...
    $result = shell_exec("java -classpath ".dirname(__FILE__)." multitransform1 ".$inputListFile." ".$stylesheetFile." 2>&1");
