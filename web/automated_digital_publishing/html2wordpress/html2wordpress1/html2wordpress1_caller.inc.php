 ...
 */
/**
 * @file $/web/automated_digital_publishing/html2wordpress/html2wordpress1/html2wordpress1_caller.inc.php
...
function html2wordpress1_caller($jobfile, $logDirectory)
{
    if (file_exists($jobfile) !== true)
    {
        return -1;
    }
    ...
    $result = shell_exec("java -classpath ".dirname(__FILE__)." html2wordpress1 ".$jobfile." 2>&1");
