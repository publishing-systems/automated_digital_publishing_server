 ...
 */
/**
 * @file $/web/automated_digital_publishing/workflows/html2epub1_caller.inc.php
 * @author Stephan Kreutzer
 * @since 2014-06-09
 */


function html2epub1_caller($inputHTML, $inputConfig, $logDirectory)
{
    ...
    if (file_exists($inputConfig) !== true)
    {
        return -2;
    }
    ...
    $result = shell_exec("java -classpath ".dirname(__FILE__)." html2epub1 ".$inputHTML." ".$inputConfig." 2>&1");
